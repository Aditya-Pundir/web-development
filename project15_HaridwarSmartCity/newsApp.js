  ...
  fetch(
    ...
    .then((data) => {
      ...
      data.articles.forEach((element) => {
        ...
        newsList.innerHTML += `<div class="haridwarNewsContainer"><h3>${element.title}</h3><li>${element.description}</li></div><br/>`;
      });
    });
  ...
  fetch(
    ...
    .then((data) => {
      ...
      data.articles.forEach((element) => {
        ...
        indianNewsList.innerHTML += `<div class="indianNewsContainer"><h3>${element.title}</h3><li>${element.description}</li></div><br/>`;
      });
    });
}
app();
